...
export const menuItems: MenuItem[] = [
  {
    ...
    price: 20,
    category: 'entree',
    image: '/images/menu-meaty-lasagna.svg',
    available: true,
    featured: true,
    customizations: [
      {
  ...
  },
  {
    ...
    price: 25,
    category: 'entree',
    image: '/images/menu-seafood-lasagna.svg',
    available: true,
    featured: true,
    customizations: [
      {
  ...
  },
  {
    ...
    price: 20,
    category: 'entree',
    image: '/images/menu-salisbury-steak.svg',
    available: true,
    featured: true,
    customizations: [
      {
  ...
  },
  {
    ...
    price: 28,
    category: 'entree',
    image: '/images/menu-tuscan-salmon.svg',
    available: true,
    featured: true,
    customizations: [
      {
  ...
  },
  {
    ...
    price: 5,
    category: 'appetizer',
    image: '/images/menu-shrimp-deviled-eggs.svg',
    available: true,
    featured: false,
    unitLabel: '4 for $5',
    customizations: [],
  },
  {
    ...
    price: 3,
    category: 'appetizer',
    image: '/images/menu-deviled-eggs.svg',
    available: true,
    featured: false,
    unitLabel: '4 for $3',
    customizations: [],
  },
  {
    ...
    price: 6,
    category: 'side',
    image: '/images/menu-mash-potatoes.svg',
    available: true,
    featured: false,
    customizations: [],
  },
  {
    ...
    price: 5,
    category: 'side',
    image: '/images/menu-chef-rice.svg',
    available: true,
    featured: false,
    customizations: [],
  },
  {
    ...
    price: 5,
    category: 'side',
    image: '/images/menu-string-beans.svg',
    available: true,
    featured: false,
    customizations: [],
  },
